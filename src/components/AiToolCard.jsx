...
function AiToolCard({ handleOpenToolPage, cardImage, cardTitle, cardText }) {
    return (
        <div
            ...
            className="bg-whiteCard p-4 flex flex-col items-center sm:items-start text-center sm:text-left rounded-md shadow-sm transition-all ease-in-out duration-[0.25s] relative hover:shadow-lg hover:bottom-1 bottom-0 active:scale-90 cursor-pointer"
        >
